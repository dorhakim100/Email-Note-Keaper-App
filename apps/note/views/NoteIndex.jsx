...
export function NoteIndex({ logo, setLogo }) {
    ...
    return (
        <section className='notes-main-page'>
            <h2><i class="fa-regular fa-note-sticky"></i> Notes Dashboard <i class="fa-regular fa-note-sticky"></i></h2>
            <NoteFilter className='filter-notes' onFilter={onFilter} />

            <div className='note-type-selector'>
                <label htmlFor="noteType">Select Note Type to Add <i class="fa-solid fa-list"></i></label>
                <select id="noteType" value={newNoteType} onChange={handleNoteTypeChange}>
